...
- [ ] Implement repo clone and inspection (README, requirements, pyproject) (Plan: 18; Req: R11)
- [ ] Implement setup inference engine (Plan: 18; Req: R11)
- [ ] Implement execution flow per mode (HITL/HOTL/HOOTLWO) (Plan: 18; Req: R11)
- [x] Implement system probe (CPU, RAM, GPU, OS, Apple Silicon detection) (Plan: 20; Req: R11)
- [ ] Implement Multipass VM creation and connection (Plan: 19; Req: R11)
- [ ] Implement Duckln bootstrap inside VM (Plan: 19; Req: R11)
- [ ] Implement config carryover (provider/model/mode) to VM (Plan: 19; Req: R1x1)
...
- [ ] Implement `/memory clear` command with confirmation flow (Plan: 21; Req: R11)
- [ ] Add root `AGENTS.md` and align implementation to it as the primary agent contract (Plan: 22; Req: R12)
...
- [ ] Implement `/memory clear` flow with session/project/factory reset options and confirmation (Plan: 23; Req: R12)
- [ ] Implement VM configuration prompts (CPU, memory, optional name with default duckln-vm) (Plan: 25; Req: R11)
- [ ] Implement post-VM setup guidance (connection commands display) (Plan: 26; Req: R11)
...
- [ ] Implement VM name conflict handling with auto-increment suffix (duckln-vm, duckln-vm-1, etc.) (Plan: 28; Req: R11)
